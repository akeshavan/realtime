...
if not os.path.isdir('/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Letter_1back/'):
    os.makedirs('/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Letter_1back/') #if this fails (e.g. permissions) we will get error
filename='/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Letter_1back/' + os.path.sep + '%s' %(expInfo['date'])
