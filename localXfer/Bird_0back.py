...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.73.06), August 10, 2012, at 13:16
...
if not os.path.isdir('/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Bird_0back/'):
    os.makedirs('/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Bird_0back/') #if this fails (e.g. permissions) we will get error
filename='/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Bird_0back/' + os.path.sep + '%s' %(expInfo['date'])
...
win = visual.Window(size=(1280, 1024), fullscr=True, screen=0, allowGUI=False, allowStencil=False,
    monitor=u'NEC19', color=u'black', colorSpace=u'rgb')
...
trials=data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('Run-Designs/bird_nback0.csv'),
    seed=None)
