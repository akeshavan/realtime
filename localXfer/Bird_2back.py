...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.73.06), August 10, 2012, at 13:10
...
if not os.path.isdir('/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Bird_2back/'):
    os.makedirs('/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Bird_2back/') #if this fails (e.g. permissions) we will get error
filename='/home/rt/subjects/'+expInfo['subjID']+'/ltTaskData/Bird_2back/' + os.path.sep + '%s' %(expInfo['date'])
...
trials=data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('Run-Designs/bird_nback2.csv'),
    seed=None)
