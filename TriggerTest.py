...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.73.06), August 23, 2012, at 09:53
...
expName='TriggerTest'#from the Builder filename that created this script
...
#Initialise components for routine:good
goodClock=core.Clock()
...
#keep track of which have finished
goodComponents=[]#to keep track of which have finished
goodComponents.append(text_2)
goodComponents.append(key_resp_2)
for thisComponent in goodComponents:
    if hasattr(thisComponent,'status'): thisComponent.status = NOT_STARTED
#start the Routine
continueRoutine=True
while continueRoutine:
