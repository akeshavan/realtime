...
json = {"subject_id":"",
        ...
        "Protocol":[{"name":"Localizer",
                     "Steps":[{"text":"Test Display","ui":"button","disabled":True,"time":"","history":[]},
                              ...
                              {"text":"Test BirdSounds","ui":"button","disabled":True,"time":"","history":[]},                              
                              {"text":"Test LetterSounds","ui":"button","disabled":True,"time":"","history":[]},                              
                     ...
                     "stepIndex":{},  ## autogenerated, leave blank
                     "active":True, 
                     "complete":False},
                    {"name":"Visit 1",
                     "Steps":[{"text":"Test Display","ui":"button","disabled":True,"time":"","history":[]},
...
## 1. duplicate RT Runs until we have the right number of runs per visit
