...
json = {"subject_id":"",
        ...
        "Protocol":[{"name":"Localizer",
                     "Steps":[{"text":"Test Display","ui":"button","disabled":False,"time":"","history":[]},
                              ...
                              {"text":"Acquire AAScout", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                              {"text":"Acquire MEMPRAGE", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                              {"text":"Acquire diffusion-fieldmap", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                              {"text":"Acquire diffusion-scan", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                              {"text":"Acquire resting-state-fieldmap", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                              {"text":"Acquire resting-state", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                    ...
                    {"name":"Visit 1",
                     "Steps":[{"text":"Test Display","ui":"button","disabled":True,"time":"","history":[]},
                              ...
                              {"text":"Acquire localizer32 ", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
                              {"text":"Acquire AAScout", "ui":"checkbox","disabled":True,"checked":False,"time":"","history":[]},
