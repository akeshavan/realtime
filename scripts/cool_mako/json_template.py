...
json = {"subject_id":"",
        ...
        "Protocol":[{"name":"Localizer",
                     "Steps":[{"text":"Test Display","ui":"button","disabled":False,"time":""},
                              ...
                              {"text":"Run MEMPRAGE", "ui":"checkbox","disabled":True,"time":""},
                              {"text":"Run diffusion fieldmap", "ui":"checkbox","disabled":True,"time":""},
                              {"text":"Run diffusion scan", "ui":"checkbox","disabled":True,"time":""},
                              {"text":"Run resting state fieldmap", "ui":"checkbox","disabled":True,"time":""},
